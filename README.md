...
The public provider and tool counts are rendered from `providerCoverageStats()` in `src/connectors/registry.ts`, after generic request helper tools are attached to implemented providers. The implemented connectors are the modules in `src/connectors/`: `acuity`, `agentmail`, `airtable`, `apify`, `apollo`, `attio`, `aws`, `bigquery`, `calcom`, `calendly`, `canva`, `channel_talk`, `channel_talk_documents`, `chatwork`, `clarity`, `clay`, `cloudflare`, `cloudsign`, `customerio`, `dataforseo`, `discord`, `facebook_messenger`, `figma`, `firecrawl`, `framer`, `freee`, `github`, `gmail`, `godaddy`, `google_admin`, `google_ads`, `google_analytics`, `google_calendar`, `google_cloud`, `google_drive`, `google_forms`, `google_gsc`, `google_maps`, `google_sheets`, `google_slides`, `google_tag_manager`, `granola`, `grantry`, `heyreach`, `higgsfield`, `hubspot`, `intent_engine`, `intercom`, `jicoo`, `jira`, `langgraph`, `langsmith`, `line`, `linear`, `linkedin_ads`, `mailchimp`, `meta_ads`, `meta_ads_platform`, `microsoft_ads`, `microsoft_teams`, `miro`, `moneyforward`, `monid`, `nocodb`, `notion`, `openai`, `openai_ads`, `openrouter`, `railway`, `railway_api`, `reddit`, `resend`, `salesforce`, `seminar_portal`, `sendgrid`, `sentry`, `shopify`, `slack`, `smartlead`, `snowflake`, `stripe`, `supabase`, `tiktok_ads`, `timerex`, `tldv`, `twenty`, `vercel`, `webflow`, `wordpress`, `x`, `yahoo_ads`, `youcanbookme`, `youtube`, `zapmail`, `zendesk`, `zoom`.
