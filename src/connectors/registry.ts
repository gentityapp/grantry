...
export const PROVIDERS: Record<string, ProviderDef> = {
  ...
  moneyforward: {
    ...
    label: "マネーフォワード",
    authTypes: ["pat", "oauth"],
    helpText: "Connect Money Forward Cloud APIs with either a workspace-owned OAuth app or a Money Forward API key. API keys are exchanged for short-lived JWTs via /auth/exchange and execute against the services enabled on the issuing user's key.",
    tokenUrl: "https://app-portal.moneyforward.com/",
    oauthSetupUrl: "https://app-portal.moneyforward.com/",
    oauthScopes: ["mfc/consolidated-accounting/master.read", "mfc/consolidated-accounting/report.read", "mfc/consolidated-accounting/report.write"],
    authorizeUrl: "https://api.biz.moneyforward.com/authorize",
    oauthTokenUrl: "https://api.biz.moneyforward.com/token",
    tools: [
      "moneyforward/list_services",
      "moneyforward/request",
      "moneyforward/conac_list_companies",
      "moneyforward/conac_get_company",
      "moneyforward/conac_list_segments",
      "moneyforward/conac_list_users",
      "moneyforward/conac_list_consolidated_accounts",
      "moneyforward/conac_list_journal_types",
      "moneyforward/conac_list_accounting_units",
    ],
    implemented: true,
  },
  google_maps: {
...
const GENERIC_REQUESTS: Record<string, NonNullable<ProviderDef["genericRequest"]>> = {
  ...
  moneyforward: {
    baseUrl: "https://api.biz.moneyforward.com",
    defaultMethods: ["GET"],
    allowedPathPrefixes: ["/"],
  },
  google_maps: {
