...
export const PROVIDERS: Record<string, ProviderDef> = {
  ...
  google_tag_manager: {
    ...
    oauthSetupUrl: "https://console.cloud.google.com/apis/credentials",
    oauthScopes: ["https://www.googleapis.com/auth/tagmanager.readonly", "https://www.googleapis.com/auth/tagmanager.edit.containers", "https://www.googleapis.com/auth/tagmanager.publish", "https://www.googleapis.com/auth/userinfo.email"],
    authorizeUrl: "https://accounts.google.com/o/oauth2/v2/auth",
    oauthTokenUrl: "https://oauth2.googleapis.com/token",
    tools: ["google_tag_manager/list_accounts", "google_tag_manager/list_containers", "google_tag_manager/get_container", "google_tag_manager/list_workspaces", "google_tag_manager/list_tags", "google_tag_manager/create_tag", "google_tag_manager/create_version", "google_tag_manager/publish_version"],
    implemented: true,
  },
  google_cloud: {
    key: "google_cloud",
