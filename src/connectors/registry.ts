...
export const PROVIDERS: Record<string, ProviderDef> = {
  ...
  moneyforward: {
    ...
    authTypes: ["oauth"],
    helpText: "Connect Money Forward Cloud Accounting via a workspace-owned OAuth app. Cloud Accounting API does not support Money Forward API keys; register an app in the Money Forward app portal and enable クラウド会計・確定申告 app integration permissions.",
