...
export const PROVIDERS: Record<string, ProviderDef> = {
  ...
  google_cloud: {
    ...
    label: "Google Cloud",
    authTypes: ["oauth"],
    helpText: "Connect your Google account to list Cloud projects/services and read Cloud Logging entries (read-only).",
    oauthSetupUrl: "https://console.cloud.google.com/apis/credentials",
    oauthScopes: ["https://www.googleapis.com/auth/cloud-platform.read-only", "https://www.googleapis.com/auth/userinfo.email"],
    authorizeUrl: "https://accounts.google.com/o/oauth2/v2/auth",
    oauthTokenUrl: "https://oauth2.googleapis.com/token",
    tools: ["google_cloud/list_projects", "google_cloud/get_project", "google_cloud/list_services", "google_cloud/list_log_entries"],
    implemented: true,
  },
  google_admin: {
    key: "google_admin",
